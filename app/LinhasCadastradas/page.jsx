        ...
        {linhas.map((linha) => (
          ...
          >
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2">
              ...
              <p><strong>Qtd:</strong> {linha.quantidade}</p>
              <p><strong>Tonalidade:</strong> {linha.tonalidade}</p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-2 items-center">
              ...
              <input
                type="number"
                placeholder="Qtd"
                value={valores[linha._id] || ""}
                onChange={(e) =>
                  setValores({
                    ...valores,
                    [linha._id]: e.target.value,
                  })
                }
              ...
              <button
                onClick={() => diminuirQuantidade(linha._id)}
              ...
              <button
                onClick={() => deletarLinha(linha._id)}
...
export default LinhasCadastradas;